...
LS   = os.path.join(BASE, "LOK shabha data")
RS   = os.path.join(BASE, "rajya shabha")
...
def main():
    ...
    exp.to_csv(os.path.join(BASE, "clean_expenditure.csv"), index=False, encoding="utf-8-sig")
    ...
    san.to_csv(os.path.join(BASE, "clean_sanctioned.csv"), index=False, encoding="utf-8-sig")
    ...
    com.to_csv(os.path.join(BASE, "clean_completed.csv"), index=False, encoding="utf-8-sig")
    ...
    alloc.to_csv(os.path.join(BASE, "clean_allocated.csv"), index=False, encoding="utf-8-sig")
